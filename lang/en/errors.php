...
return [
    ...
    // Subscription plans.
    'subscription' => [
        'insufficient_balance' => 'Your spendable balance doesn’t cover this plan’s monthly price. Top up your wallet, then subscribe.',
        'plan_not_found' => 'That plan is no longer available. Please pick another.',
    ],

    // FX rates (platform-admin).
    'fx' => [
        'sync_unavailable' => 'The exchange-rate provider isn’t configured, so rates can’t be synced. The last good rate stays in place.',
        'rate_stale' => 'The latest exchange rate is too old to bill on. Sync rates and try again.',
        'rate_unavailable' => 'No exchange rate is available for that currency pair yet.',
    ],
